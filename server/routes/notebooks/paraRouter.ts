  ...
  router.post(
    {
      ...
      validate: {
        body: schema.object({
          ...
          paragraphResult: schema.maybe(schema.string()),
  ...
  router.post(
    {
      ...
      validate: {
        body: schema.object({
          ...
          deepResearchSystemPrompt: schema.maybe(schema.string()),
          deepResearchExecutorSystemPrompt: schema.maybe(schema.string()),
        }),
      },
    },
    async (
